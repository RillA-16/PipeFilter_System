...
public class SatisfiedSinkFilter extends CommonFilterImpl {
	private String sinkFile;

	public SatisfiedSinkFilter(int outPort, int inPort) {
	...
	public boolean specificComputationForFilter() throws IOException {
		...
		while (true) {
			...
			if (byte_read == -1) {
				fw.close();
				System.out.println("::Filtering is finished; Output file-1 is created.");
				return true;
			}
